...
public class TestObjectsFactory {
		...
		TradeState.TradeStateBuilder tradeStateBuilder = TradeState.builder()
				.setTrade(Trade.builder()
						...
						.setTradableProduct(TradableProduct.builder()
								...
								.addSettlementInstructions(getSettlementInstructions(settlementDate, dirtyPrice, quantity, tradedCurrency)))
	...
	private PriceQuantity getPriceQuantity(double notional, String productIdentifier, double cleanPrice, String tradedCurrency) {
		return PriceQuantity.builder()
				.addPrice(FieldWithMetaPrice.builder()
						...
						.setValue(Price.builder()
								...
								.setPriceType(PriceTypeEnum.CLEAN_PRICE))
				)
	...
	private SettlementInstructions getSettlementInstructions(LocalDate settlementDate, double dirtyPrice, long quantity, String settlementCurrency) {
		return SettlementInstructions.builder()
					...
					.setSettlementDate(SettlementDate.builder()
							.setSettlementDate(AdjustableOrRelativeDate.builder()
									.setAdjustableDate(AdjustableDate.builder()
											.setAdjustedDateValue(DateImpl.of(settlementDate)))))
